...
Le challenge place les participants dans le rôle d'analyste de données relatives à la chaine de valeur du Cacao en Côte d’Ivoire. Les données sont organisées en 10 tables dont 9 dimensions et une de faits (Fact_Mouvements).
